...
extern "C" {
    ...
    void launch_settings(EFI_SYSTEM_TABLE *SystemTable) {
        int win_w = 640;
        int win_h = 480;
        ...
        while (!done) {
            ...
            if (redraw) {
                ...
                blankUI_draw_text_color(win_x + 40, win_y + 60, (char*)"Display", 0x000000);
                blankUI_draw_text_color(win_x + 40, win_y + 80, (char*)"Resolution: 1024x768 (Native)", 0x666666);
                
                blankUI_draw_text_color(win_x + 40, win_y + 120, (char*)"System Updates", 0x000000);
                blankUI_draw_text_color(win_x + 40, win_y + 140, (char*)"Running BlankOS Version 1.2.8", 0x666666);
